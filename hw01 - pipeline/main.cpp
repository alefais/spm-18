...
int main(int argc, char** argv) {
    ...
    std::cout << "### Tpar(n) = " << time1 << " usecs to traverse the pipeline (balanced stages)." << std::endl;
    ...
    std::cout << "### Tpar(1) = " << time2 << " usecs to traverse the pipeline (balanced stages)." << std::endl;
    ...
    std::cout << "### Tseq = " << time3 << " usecs to finish the computation." << std::endl;
    ...
    std::cout << "### Tpar(n) = " << time4 << " usecs to traverse the pipeline (unbalanced stages)." << std::endl;
    ...
    std::cout << "### Tpar(1) = " << time5 << " usecs to traverse the pipeline (unbalanced stages)." << std::endl;
    ...
    std::cout << "Final results (balanced version): \t"
              << "S(n) = " << scalability1
              << "\t\tE(n) = " << efficiency1
              << "\t\tSp(n) = " << speedup1
              << std::endl;
    std::cout << "Final results (unbalanced version): \t"
              << "S(n) = " << scalability2
              << "\t\tE(n) = " << efficiency2
              << "\t\tSp(n) = " << speedup2
              << std::endl;
